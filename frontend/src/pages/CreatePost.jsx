...
const handleSurpriseMe = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <div className="mt-5 flex gap-5"> {/* wrap subtmit button */}
        <button
        type="button"
      ...
      <div className ="mt-10">
        <p className = "mt-2 text-[#666e75] text-[15px]">Once you have created the image you want, you can share it with others
          in the community
        </p>
        <button
        type="submit"
